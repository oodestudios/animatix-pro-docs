...
![GraphFlow Editor Window – Main editor interface showing node canvas, toolbar, and minimap with connected nodes visible](/img/images/graphflow-editor-window.png)
...
![Node Palette – Right-click context menu showing Trigger, Animation, Action, Event, Condition, and Delay node categories](/img/images/node-palette.png)
...
![Connection System – GraphFlow Editor canvas showing multiple nodes with connection lines linking output ports to input ports](/img/images/connection-system.png)
...
![Node Inspector – Inspector panel displaying Fade node properties organized into Basic Settings, Animation Values, and Advanced Options sections](/img/images/node-inspector.png)
...
![Animation Curve Editor – Curve editor window showing animation curve with control points for custom easing](/img/images/animation-curve-editor.png)
...
![GraphFlow Editor Full Interface – Complete editor window with graph canvas, toolbar, node palette, inspector, and minimap all visible](/img/images/graphflow-editor-full-interface.png)
