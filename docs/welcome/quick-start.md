...
![Create GraphFlow Asset – Project window context menu showing Create → Animatix Pro → GraphFlow Asset option](/img/images/create-graphflow-asset.png)
...
![Basic Node Connection – GraphFlow Editor showing On Start node connected to Fade node with connection line](/img/images/basic-node-connection.png)
...
![Fade Node Configuration – Inspector panel showing Fade node with Duration, Fade Start, Fade End, and Easing properties](/img/images/fade-node-configuration.png)
...
![GraphExecutor Setup – Inspector showing GraphExecutor with ButtonFadeIn GraphFlow Asset assigned to Graph Asset field](/img/images/graphexecutor-assignment.png)
...
![Animation Result – Button GameObject fading in from transparent to fully visible over 1 second](/img/images/fade-in-result.gif)
