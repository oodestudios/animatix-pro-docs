...
![Trigger Nodes – Diagram showing various trigger node types with their output ports ready to connect](/img/images/trigger-nodes.png)
...
![Animation Nodes – Collection of animation node icons showing Fade, Move, Scale, Rotate, Slide nodes](/img/images/animation-nodes.png)
...
![Action Nodes – Collection of action node icons showing Play Audio, Enable GameObject, Trigger Event nodes](/img/images/action-nodes.png)
...
![Condition Nodes – Diagram showing Condition node with single output port evaluating conditions (e.g., If Player Enter, If has tag)](/img/images/condition-nodes.png)
...
![Delay Nodes – Diagram showing Wait node with configurable duration parameter](/img/images/delay-nodes.png)
...
![Event Nodes – Diagram showing On Complete event node connecting to external systems](/img/images/event-nodes.png)
...
![Looping Example – Diagram showing animation graph with loop connection back to trigger](/img/images/looping-example.png)
...
![Complete Graph Flow Example – Full graph showing all node types connected in sequence from trigger to completion](/img/images/complete-graph-flow.png)
