...
![Sequential Execution Timeline – Diagram showing timeline of sequential node execution with no overlap](/img/images/sequential-execution-timeline.png)
...
![Parallel Execution Timeline – Diagram showing timeline of parallel node execution with overlap](/img/images/parallel-execution-timeline.png)
...
![Mixed Execution Pattern – Graph showing parallel execution followed by sequential steps](/img/images/mixed-execution-pattern.png)
