...
|----------------------------|-----------------------------------|----------------------|-------------------------|
| `49.trigger-relay-node-editor.png` | `49.trigger-relay-node-editor.png` | `docs/advanced/parallel-execution.md`<br>`docs/node-types/trigger-nodes.md` | GraphFlow Editor showing Trigger Relay node (purple header) positioned between a Trigger node and multiple animation nodes. Should clearly show the node's visual appearance in the editor. |
...
### Image 49: `49.trigger-relay-node-editor.png`
...
### Image 50: `50.trigger-relay-multiple-connections.png`
...
### Image 53: `53.trigger-relay-parallel-execution-timeline.png`
...
### Image 54: `54.trigger-relay-same-object-animation.gif`
